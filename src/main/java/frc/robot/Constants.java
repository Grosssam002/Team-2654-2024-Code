...
public final class Constants {
  public static class Drivetrain {
    ...
    public static final double FRONT_LEFT_MODULE_STEER_OFFSET_RADIANS = 2.793379 - Math.PI;

    public static final int FRONT_RIGHT_MODULE_DRIVE_MOTOR = 2;
    public static final int FRONT_RIGHT_MODULE_STEER_MOTOR = 1;
    public static final int FRONT_RIGHT_MODULE_STEER_ENCODER = 10;
    public static final double FRONT_RIGHT_MODULE_STEER_OFFSET_RADIANS = 0.7639224;
    ...
    public static final double BACK_LEFT_MODULE_STEER_OFFSET_RADIANS = 2.187457 - Math.PI;

    public static final int BACK_RIGHT_MODULE_DRIVE_MOTOR = 6;
    public static final int BACK_RIGHT_MODULE_STEER_MOTOR = 5;
    public static final int BACK_RIGHT_MODULE_STEER_ENCODER = 12;
    public static final double BACK_RIGHT_MODULE_STEER_OFFSET_RADIANS = -0.5246;
}
